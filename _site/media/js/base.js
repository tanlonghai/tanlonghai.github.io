...
//    //email显示
//    $(".myemail").click(function(){var d="tanlonghai.github.io";var f="gmail.com";var e=d+"@"+f;$(this).hide();setTimeout(function(){var g=$(".myemail");g.next().hide();g.text(e);g.attr("href","mailto:"+e).unbind("click");g.fadeIn(2000)},1)});
//    //网盘
